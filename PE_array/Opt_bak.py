...
class MacModel:
    ...
    def run(self, max_size=32):
        ...
        for i in range(max_size):
            ...
            self.dsp_eff_list.append(core_size*core_num/self.DSP_tol)
...
def main_test():
    DSP_tol = 1024
    size_tol1 = cal_size(100,768)
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n",size_tol1)
    size_tol2 = cal_size(100,3072)
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n",size_tol2)
    size_tol3 = cal_size(300,768)
    size_tol4 = cal_size(300,3072)
    size_tol5 = cal_size(500,768)
    size_tol6 = cal_size(500,3072)
...
#6
    ...
    plt.plot(y_11,y_52,'b.--')
    plt.plot(y_11,y_53,'g.--')
    plt.plot(y_11,y_54,'r.--')
    plt.plot(y_11,y_55,'r.--')
    plt.plot(y_11,y_56,'r.--')
    
    # plt.legend(['seq_len = 100','','','','',''],loc='upper left') 
