...
def main():
    root = "F:\\0xjw_learning\\home\\data\\processed_data_test_5g"
    data_prepare = DataPrepare(data_folder=root,
                               save_dir="F:\\0xjw_learning\\home\\data\\result\\checkpoint_test",
                               save_sample_path='F:\\0xjw_learning\\home\\data\\sample_test',
    ...
    dataset = SpatialTimeDataset('F:\\0xjw_learning\\home\\data\\sample_test')
