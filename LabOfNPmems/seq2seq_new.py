...
class Seq2seq_new(nn.Module):
    ...
    def forward(self, z_in, device):
        ...
        print("encoder_hidden shape   ",encoder_hidden.shape,z_in.shape)
...
class DecoderModel(nn.Module):
    ...
    def forward(self, z, channel_first=False, apply_softmax=False):
        ...
        z = F.max_pool2d(z,kernel_size=(1,4))
        # print(z.shape)
